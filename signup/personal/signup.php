            ...
            >
                ...
                <div class="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 mx-auto">
                    ...
                    >
                        ...
                        <div class="col ">
                            <input type="submit" class="form-control bg-blue text-white py-3" value="Create Account">

                        </div>

                    </form>
                    <div class="col text-center mt-4">
                        <a href="../../forgot-password.php" class=" text-decoration-none text-blue fw-bold">Forgot Password</a>

                        <p class="text-blue">Already have an Account? <a href="../../login.php" class="text-blue fw-bold">Log In</a> </p>
                    </div>
